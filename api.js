...
const ShopAPI = {
  ...
  giftPoints: (userId, amount) => apiRequest('/admin/gift', { method: 'POST', body: { userId, amount } })
};

window.API = { AuthAPI, PostsAPI, AssignmentsAPI, ProjectsAPI, UsersAPI, AdminAPI, UploadAPI, ActivityAPI, ShopAPI };
